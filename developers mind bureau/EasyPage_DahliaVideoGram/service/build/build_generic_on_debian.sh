##gcc -std=c17 `pkg-config --cflags gtk+-3.0` ./../source/main.c -o main

#using echo "`pkg-config --cflags gtk+-3.0`" produced the following line"
...
link_glib_twopointzero="-lglib-2.0"

#compile
cc -std=c17 $gtk_threepointzero $glib_gio_twopointzero $glib_gobject_twopointerk ./../source/main.c -o main $link_glib_twopointzero
